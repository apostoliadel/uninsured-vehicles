...
if (isset($_POST['clear'])) {
    ...
    $name = $duration = $licensePlate = $vehicleType = $renewalPrice = "";
		...
		if (!$fieldsCompleted) {
			...
			$generatedMessage .= "The vehicle with license plate " . $licensePlate . " ";
			$generatedMessage .= "(Owner: " . $name . ", Type: " . $vehicleType . ")";
			$generatedMessage .= " is currently uninsured and in motion on the new Open Car service via gov.gr. <br><br>";
			$generatedMessage .= "It is important to note that uninsured vehicles may be electronically checked by the AADE, ";
